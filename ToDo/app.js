window.addEventListener('DOMContentLoaded', () => {
    ...
    (function(arrOfTasks) {
        ...
        function renderAllTasks(tasksList) {
            if (!tasksList) {
                console.error('Please, provide list of tasks!');
                return;
            }
        ...
        function onFormSubmitHandler(e) {
            ...
            if (!titleValue || !bodyValue) {
                alert('Please enter task name and body');
                return;
            }
        ...
        function deleteTask(id) {
            ...
            const isConfirm = confirm(`Do you want remove task: "${title}"?`);
        ...
        function onThemeSelectHandler(e) {
            const selectedTheme = themeSelect.value,
                  isConfirmed = confirm(`Do you realy want to change theme: ${selectedTheme}`);
