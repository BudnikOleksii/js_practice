...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      statusMessage.classList.add('status'); // insert our message in parent cause we need to hide our form
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        present.style.marginRight = "".concat(scroll, "px");
      });
    });
...
var scrolling = function scrolling(upSelector) {
  ...
  //             smoothScrool(scrollTop, hashElementTop, this.hash);
  //         }
  //     });
  // };
  // const smoothScrool = (from, to, hash) => {
  //     let timeInterval = 1,
  //         prevScrollTop,
  //         speed;
  //     if (to > from) {
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  var btn = document.querySelector(trigger); // cards.forEach(card => {
...
// await for fetch cause we need to wait for result from promise
